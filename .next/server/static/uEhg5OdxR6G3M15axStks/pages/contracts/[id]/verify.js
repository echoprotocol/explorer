...
module.exports = __webpack_require__("xoRY");
...
// EXTERNAL MODULE: ./src/public/images/icons/verify-icn.svg
var verify_icn = __webpack_require__("wEaj");
var verify_icn_default = /*#__PURE__*/__webpack_require__.n(verify_icn);
...
// CONCATENATED MODULE: ./src/components/VerifyContract/index.jsx
...
const CodeMirror = dynamic_default()(() => __webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, "8x7O")).then(component => component.UnControlled), {
  ssr: false,
  loadableGenerated: {
...
class VerifyContract_VerifyContract extends external_react_default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      loader: false,
    ...
    this.backwards = external_react_default.a.createRef();
    this.checkboxEVM = external_react_default.a.createRef();
    this.intervalId = 0;
  }
  ...
  onKeyDown(e) {
    if (e.shiftKey && e.which === GlobalConstants["i" /* KEY_CODES */].TAB_CODE) {
      e.preventDefault();
      this.backwards.current.focus();
      return;
    }

    if (e.which === GlobalConstants["i" /* KEY_CODES */].TAB_CODE) {
      e.preventDefault();
  ...
  isDisabled() {
    ...
    return form.get('currentCompiler').error || form.get('contractInputs').some(input => input.error) || !form.get('code') || form.get('loading') || loader;
  }
  ...
  showLoader(loader) {
    ...
    if (loader && this.state.timer > 5 && !is_nan_default()(progress)) {
      return __jsx("div", {
        className: "progress-render"
      }, `${progress}%`);
    }
  ...
  render() {
    ...
    return __jsx("div", {
      className: "inner-container inner-page verify-contract"
    }, __jsx("div", {
      className: "backwards"
    }, __jsx("a", {
      href: "",
      ...
      src: verify_icn_default.a,
      alt: ""
    })), __jsx("div", {
      className: "title"
    }, `Verify contract ${id}`))), __jsx("div", {
      className: "page-helper-section"
    }, __jsx("div", {
      className: "section-description"
    }, "Upload the source code of your contract. If you have more then one contract, they should be united in one file"), __jsx("div", {
    ...
    }, "or copy/past contract code in textarea"), this.showLoader(loader)), __jsx("div", {
      ...
      className: "section-description"
    }, "Provide information about contract"), __jsx("div", {
      className: "verify-contract-table mb40"
    }, __jsx("div", {
      className: "row"
    }, __jsx("div", {
      className: "t-name"
    }, "Contract type:"), __jsx("div", {
      className: "t-value"
    }, __jsx("div", {
      ...
      className: "t-name"
    }, "Compiler version:"), __jsx("div", {
      className: "t-value"
    }, __jsx("div", {
      className: "select-container"
    }, __jsx(external_semantic_ui_react_["Dropdown"], {
      className: "compiler",
      ...
      disabled: form.get('loading')
    }), form.get('currentCompiler').error && __jsx("div", {
      className: "error-field"
    }, form.get('currentCompiler').error)))), __jsx("div", {
      className: "row"
    }, __jsx("div", {
      className: "t-name"
    }, "Contract to compile:"), __jsx("div", {
      className: "t-value"
    }, __jsx("div", {
      className: "select-container"
    }, __jsx(external_semantic_ui_react_["Select"], {
      className: "compiler",
    ...
    }))))), form.get('contractInputs').size ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
      className: "section-description"
    }, "Define constructor arguments"), __jsx("div", {
      className: "verify-contract-table"
    }, form.get('contractInputs').map((input, name) => __jsx("div", {
      className: "row",
      key: name.toString()
    }, __jsx("div", {
      className: "t-name"
    }, `${name} (${input.type})`), __jsx("div", {
      className: "t-value"
    }, __jsx("div", {
      className: "input-wrapper"
    }, __jsx(external_semantic_ui_react_["Input"], {
      value: input.value,
      onChange: e => this.onInput(e, name)
    }), input.error && __jsx("div", {
      className: "error-field"
    }, input.error))))).toArray())) : null), __jsx("div", {
...
VerifyContract_VerifyContract.defaultProps = {
  historyLength: 0,
  progress: 0
};
/* harmony default export */ var components_VerifyContract = (VerifyContract_VerifyContract);
// EXTERNAL MODULE: ./src/constants/FormConstants.js
var FormConstants = __webpack_require__("SYHU");
...
// CONCATENATED MODULE: ./src/containers/VerifyContract/index.jsx
...
/* harmony default export */ var containers_VerifyContract = (Object(router_["withRouter"])(Object(external_react_redux_["connect"])(state => ({
  form: state.form.get(FormConstants["b" /* FORM_CONTRACT_VERIFY */]),
  ...
  setValue: (field, value) => dispatch(FormActions["a" /* default */].setValue(FormConstants["b" /* FORM_CONTRACT_VERIFY */], field, value)),
  setInFormValue: (fields, value) => dispatch(FormActions["a" /* default */].setInFormValue(FormConstants["b" /* FORM_CONTRACT_VERIFY */], fields, value)),
  clear: () => dispatch(FormActions["a" /* default */].clearForm(FormConstants["b" /* FORM_CONTRACT_VERIFY */])),
  contractCodeCompile: code => dispatch(ContractActions["a" /* default */].contractCodeCompile(code)),
  contractCompilerInit: () => dispatch(ContractActions["a" /* default */].contractCompilerInit()),
  changeContractCompiler: version => dispatch(ContractActions["a" /* default */].changeContractCompiler(version)),
  updateConstructorParamsForm: () => dispatch(ContractActions["a" /* default */].updateConstructorParamsForm()),
  contractVerifyApprove: id => dispatch(ContractActions["a" /* default */].contractVerifyApprove(id))
}))(components_VerifyContract)));
// CONCATENATED MODULE: ./src/pages/contracts/[id]/verify.jsx

/* harmony default export */ var verify = __webpack_exports__["default"] = (containers_VerifyContract);
