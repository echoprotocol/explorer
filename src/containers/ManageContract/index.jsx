...
export default withRouter(connect(
	...
	(dispatch, props) => ({
		...
		manageContract: (id, name, icon, description) => dispatch(ContractActions.manageContract(id, name, icon, description)),
		...
		cancelFieldsContract: () => dispatch(ContractActions.cancelFieldsContract()),
