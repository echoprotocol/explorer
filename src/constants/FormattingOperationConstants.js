...
export const OPS_DESCRIPTIONS = {
	[OPERATIONS_IDS.TRANSFER]: 'Transfers an amount of one asset from one account to another.',
	[OPERATIONS_IDS.TRANSFER_TO_ADDRESS]: '',
	[OPERATIONS_IDS.OVERRIDE_TRANSFER]: 'Allows the issuer of an asset to transfer an asset from any account to any account if they have override_authority.',
	[OPERATIONS_IDS.ACCOUNT_CREATE]: 'This operation is used to create an account',
	[OPERATIONS_IDS.ACCOUNT_UPDATE]: 'This operation is used to update an existing account. It can be used to update the authorities, or adjust the options on the account. See account_object::options_type for the options which may be updated. Optional fields can be added or not depending on your intentions.',
	[OPERATIONS_IDS.ACCOUNT_WHITELIST]: `This operation is used to whitelist and blacklist accounts, primarily for transacting in whitelisted assets
	...
	[OPERATIONS_IDS.ACCOUNT_ADDRESS_CREATE]: 'Creates an address for an account to which money can be transferred.',
	[OPERATIONS_IDS.ASSET_CREATE]: 'This operation is used to create assets.',
	[OPERATIONS_IDS.ASSET_UPDATE]: 'Update options common to all assets.\n' +
	...
	[OPERATIONS_IDS.ASSET_UPDATE_BITASSET]: 'Update options specific to BitAssets.\n' +
	...
	[OPERATIONS_IDS.ASSET_UPDATE_FEED_PRODUCERS]: 'Update the set of feed-producing accounts for a BitAsset.\n' +
	...
	[OPERATIONS_IDS.ASSET_ISSUE]: 'Asset issue to account.',
	[OPERATIONS_IDS.ASSET_RESERVE]: 'Used to take an asset out of circulation, returning to the issuer',
	[OPERATIONS_IDS.ASSET_FUND_FEE_POOL]: '',
	[OPERATIONS_IDS.ASSET_PUBLISH_FEED]: `Publish price feeds for market-issued assets.
